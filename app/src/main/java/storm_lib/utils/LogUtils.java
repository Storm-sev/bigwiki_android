...
public final class LogUtils {
    ...
    private static void printDeviceInfo(final String filePath) {
        ...
        int versionCode = 0;
        try {
            PackageInfo pi = MApplication.appContext
                    .getPackageManager()
                    .getPackageInfo(MApplication.appContext.getPackageName(), 0);
            if (pi != null) {
    ...
    public static class Config {
        ...
        private Config() {
            ...
            if (Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState())
                    && MApplication.appContext.getExternalCacheDir() != null)
                mDefaultDir = MApplication.appContext.getExternalCacheDir() + FILE_SEP + "log" + FILE_SEP;
            else {
                mDefaultDir = MApplication.appContext.getCacheDir() + FILE_SEP + "log" + FILE_SEP;
            }
        }
