...
public class IosAlertDialog {
    ...
    public IosAlertDialog builder() {
        ...
        lLayout_bg.setLayoutParams(new FrameLayout.LayoutParams((int) (display
                .getWidth() * 0.80), FrameLayout.LayoutParams.WRAP_CONTENT));

        return this;
    }

    public IosAlertDialog setTitle(int titleRes) {
     ...
     * 通过资源来获取文件
     */
    public IosAlertDialog setMsg(int stringRes) {

        String msg = context.getString(stringRes);
